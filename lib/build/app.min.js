...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game */ \"./lib/js/game/index.js\");\n/* harmony import */ var _mini__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mini */ \"./lib/js/mini/index.js\");\n/**\r\n * App entry point. Hook everything up.\r\n */\n\n\n\n\nclass App {\n  constructor() {\n    this.game = new _game__WEBPACK_IMPORTED_MODULE_0__[\"Game\"]();\n    this.card = new _mini__WEBPACK_IMPORTED_MODULE_1__[\"BusinessCard\"]();\n    this.piano = new _mini__WEBPACK_IMPORTED_MODULE_1__[\"Piano\"]();\n    this.chess = new _mini__WEBPACK_IMPORTED_MODULE_1__[\"Chess\"]();\n    this.initSections();\n  }\n\n  initSections() {\n    document.querySelectorAll('.section-header').forEach(e => {\n      e.onclick = () => {\n        e.parentNode.parentNode.classList.toggle('active');\n      };\n    });\n  }\n}\n\nwindow.onload = () => {\n  var app = new App();\n};\n\n//# sourceURL=webpack://XB/./lib/js/main.js?");
...
/*!******************************!*\
  !*** ./lib/js/mini/index.js ***!
  \******************************/
/*! exports provided: Piano, Chess, BusinessCard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
