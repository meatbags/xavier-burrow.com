...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./overlay */ \"./lib/js/overlay/index.js\");\n/* harmony import */ var _mobile_check__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mobile_check */ \"./lib/js/mobile_check.js\");\n/* harmony import */ var _user_interface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user_interface */ \"./lib/js/user_interface.js\");\n/* harmony import */ var _overlay2d__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlay2d */ \"./lib/js/overlay2d/index.js\");\n/**\r\n * Load mini-apps and set up UI.\r\n */\n\n\n//import { Chess, Piano, BusinessCard, Logo } from './app';\n\n\n\n\nclass App {\n  constructor() {\n    const isMobile = Object(_mobile_check__WEBPACK_IMPORTED_MODULE_1__[\"mobileCheck\"])();\n    this.ui = new _user_interface__WEBPACK_IMPORTED_MODULE_2__[\"UserInterface\"]();\n    //this.overlay = new Overlay();\n    this.overlay2D = new _overlay2d__WEBPACK_IMPORTED_MODULE_3__[\"Overlay2D\"]();\n\n    /*\r\n    //this.menu = new UserInterface();\r\n    if (isMobile) {\r\n      document.querySelectorAll('.mobile-remove').forEach(e => { e.remove(); });\r\n    } else {\r\n      //this.overlay = new Overlay();\r\n      this.card = new BusinessCard();\r\n      this.piano = new Piano();\r\n      this.logo = new Logo();\r\n      this.chess = new Chess();\r\n    }\r\n    */\n  }\n}\n\nwindow.onload = () => {\n  var app = new App();\n};\n\n//# sourceURL=webpack://XB/./lib/js/main.js?");
...
/***/ "./lib/js/overlay2d/index.js":
/*!***********************************!*\
  !*** ./lib/js/overlay2d/index.js ***!
  \***********************************/
/*! exports provided: Overlay2D */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _overlay_2d__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./overlay_2d */ \"./lib/js/overlay2d/overlay_2d.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Overlay2D\", function() { return _overlay_2d__WEBPACK_IMPORTED_MODULE_0__[\"Overlay2D\"]; });\n\n\n\n//# sourceURL=webpack://XB/./lib/js/overlay2d/index.js?");

/***/ }),

/***/ "./lib/js/overlay2d/node.js":
/*!**********************************!*\
  !*** ./lib/js/overlay2d/node.js ***!
  \**********************************/
