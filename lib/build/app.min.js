...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Logo\", function() { return Logo; });\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dom */ \"./lib/js/dom/index.js\");\n\n\nclass Logo {\n  constructor() {\n    this.window = new _dom__WEBPACK_IMPORTED_MODULE_0__[\"Window\"]('undefined', 200, 100, window.innerWidth / 2 - 260, 300);\n    this.domElement = document.querySelector('#logo-target');\n    this.window.el.body.appendChild(this.domElement);\n    this.window.domElement.classList.add('transparent');\n    this.domElement.classList.remove('display-none');\n  }\n}\n\n\n\n//# sourceURL=webpack://XB/./lib/js/app/logo.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./overlay */ \"./lib/js/overlay/index.js\");\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app */ \"./lib/js/app/index.js\");\n/* harmony import */ var _mobile_check__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mobile_check */ \"./lib/js/mobile_check.js\");\n/* harmony import */ var _user_interface__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user_interface */ \"./lib/js/user_interface.js\");\n/**\r\n * Load mini-apps and set up UI.\r\n */\n\n\n\n\n\n\nclass App {\n  constructor() {\n    const isMobile = Object(_mobile_check__WEBPACK_IMPORTED_MODULE_2__[\"mobileCheck\"])();\n    this.menu = new _user_interface__WEBPACK_IMPORTED_MODULE_3__[\"UserInterface\"]();\n\n    if (isMobile) {\n      document.querySelectorAll('.mobile-remove').forEach(e => {\n        e.remove();\n      });\n    } else {\n      this.overlay = new _overlay__WEBPACK_IMPORTED_MODULE_0__[\"Overlay\"]();\n      this.card = new _app__WEBPACK_IMPORTED_MODULE_1__[\"BusinessCard\"]();\n      this.piano = new _app__WEBPACK_IMPORTED_MODULE_1__[\"Piano\"]();\n      this.logo = new _app__WEBPACK_IMPORTED_MODULE_1__[\"Logo\"]();\n      this.chess = new _app__WEBPACK_IMPORTED_MODULE_1__[\"Chess\"]();\n    }\n  }\n}\n\nwindow.onload = () => {\n  var app = new App();\n};\n\n//# sourceURL=webpack://XB/./lib/js/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./overlay */ \"./lib/js/overlay/overlay.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"Overlay\", function() { return _overlay__WEBPACK_IMPORTED_MODULE_0__[\"Overlay\"]; });\n\n\n\n//# sourceURL=webpack://XB/./lib/js/overlay/index.js?");

/***/ }),

/***/ "./lib/js/overlay/overlay.js":
/*!***********************************!*\
  !*** ./lib/js/overlay/overlay.js ***!
  \***********************************/
/*! exports provided: Overlay */
